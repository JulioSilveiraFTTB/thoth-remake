@php
    ...
    $planningProgress = isset($progress["planning"]) ? (int) $progress["planning"] : 0;
    $conductingProgress = isset($progress["conducting"]) ? (int) $progress["conducting"] : 0;
@endphp
                ...
                <div class="progress-wrapper">
                    ...
                    <div class="progress">
                        <div
                            ...
                            role="progressbar"
                            aria-valuenow="{{ $conductingProgress }}"
                            aria-valuemin="0"
                            aria-valuemax="100"
                            style="width: {{ $conductingProgress }}%"
                        ></div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="progress-wrapper">
                    <div class="progress-info">
                        <div class="progress-percentage">
                            <span class="text-sm font-weight-bold">
                                {{ __("project/overview.snowballing") }}
                            </span>
                        </div>
                    </div>
                    <div class="card-body">
